...
%Wing Data
S = 94; % Main Wing area. m^2
b = 35.48; % Wing Span m
AR = 13.39; %Aspect ratio
...
TaperR = 0.16; %Wing Taper ratio
Croot = 3.92; % Wing root Chord legnth. m
yCroot = 1.712; % Distance of wing root chord from centerline. m
ZLA = -2.87; % zero-lift angle of attack (deg)

%Overall Aircraft Data
MTOW = 34831; % Max Take off Weight of the aircraft. kg
ClmaxL = 2.7; % Maximum aircraft lift coefficient at landing
LD = 16.9; % Lift / Drag ratio for aircraft
XcgFwd = noseToMAC+(0.08*MAC); % Fwd CG Limit
XcgAft = noseToMAC+(0.43*MAC); % Aft CG Limit
Vs = ((MTOW*9.81)/(0.5*rho*ClmaxL*S))^0.5; % stall speed of the aircraft. m/s
...
EngineScale = 0.95; %Scale factor of our engines
...
Shtp = HTPSizing(plotHtpGraphs, MAC, h0, a, ahtpC, ClmaxL, lhtp, deda, Cm0, xNLG, xMLG, hNLG, hMLG, Ct, zt, rho, Vmc, S, MTOW, cgRange, CltMin);
