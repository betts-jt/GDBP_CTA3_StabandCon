...
if ASizingMethod == 0
    ...
    Sa = SaS*data('S'); %Elevator area using area ratio
        ...
        CaC = 0.3; %Initial estimate for aileron choprd legnth/wing chord legnth ratio. Need to improve when spar position is fixed.
        ...
        Ixx = (data('b')^2*data('MTOW')*data('RxBar')^2)/(4*9.81); %Initial class 1 calculation of moment of intetia using radius of gyration
